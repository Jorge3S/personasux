...
<template>
  <section class="bg-[url(https://w.forfun.com/fetch/3f/3f3cffb82c2c1fdc785b9930f4e111b0.jpeg)] bg-cover bg-center bg-no-repeat">
    <div class="grid grid-cols-3">
      ...
      <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div>
          ...
          <div class="rounded-lg bg-gray-500 p-8 shadow-lg lg:col-span-3 lg:p-12">
            <form v-on:submit.prevent action="" class="space-y-4">


              <div id="Formulario 1" v-show:value="Mostrar1">
                <div>
                  <label class="block uppercase tracking-wide text-gray-900 text-xs font-bold mb-2" for="nombre">
                    Nombre
                  </label>
                  <text1 @info= " nombre1 " > Fulano </text1>
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <div>
                    <label class="block uppercase tracking-wide text-gray-900 text-xs font-bold mb-2" for="edad">
                      Edad
                    </label>
                  ...
                  <div>
                    <label class="block uppercase tracking-wide text-gray-900 text-xs font-bold mb-2" for="estadoCivil">
                      ESTADO CIVIL
                    </label>
                    <div class="relative">
                      <select v-model="estadoCivil" class="w-full rounded-lg border-gray-900 p-3 text-sm"
                        id="estadoCivil">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <div>
                    <label class="block uppercase tracking-wide text-gray-900 text-xs font-bold mb-2" for="trabajo">
                      TRABAJO
                    </label>
                  ...
                  <div>
                    <label class="block uppercase tracking-wide text-gray-900 text-xs font-bold mb-2" for="residencia">
                      Residencia
                    </label>
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <div>
                    <label class="block uppercase tracking-wide text-gray-900 text-xs font-bold mb-2" for="cita">
                      CITA
                    </label>
                  ...
                  <div>
                    <label class="block uppercase tracking-wide text-gray-900 text-xs font-bold mb-2" for="citaAutor">
                      CITA AUTOR
                    </label>
                ...
                <div>
                  <label class="block uppercase tracking-wide text-gray-900 text-xs font-bold mb-2" for="bio">
                    BIO
                  </label>
              ...
              <div id="Formulario 3" v-show:value="Mostrar3">
                ...
                <div class="py-2">
                  <label class="block uppercase tracking-wide text-gray-900 text-xs font-bold mb-2" for="objetivos">
                    OBJETIVOS
                  </label>
                ...
                <div class="py-2">
                  <label class="block uppercase tracking-wide text-gray-900 text-xs font-bold mb-2" for="frustraciones">
                    FRUSTRACIONES
                  </label>
                ...
                <div class="py-2">
                  <label class="block uppercase tracking-wide text-gray-900 text-xs font-bold mb-2" for="motivaciones">
                    MOTIVACIONES
                  </label>
                ...
                <div class="py-2">
                  <label class="block uppercase tracking-wide text-gray-900 text-xs font-bold mb-2" for="marcas">
                    MARCAS
                  </label>
                ...
                <div class="grid grid-cols-3">
                  ...
                  <div class="p-6">
                    <button class="0inline-block w-full rounded-lg bg-white px-5 py-3 font-medium text-black sm:w-auto"
